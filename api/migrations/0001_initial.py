    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raasi', models.CharField(blank=True, max_length=50)),
                ('nakshatram', models.CharField(blank=True, max_length=50)),
                ...
                ('fathers_designation', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('unlock', 'Unlock Profile'), ('purchase', 'Purchase Credits')], max_length=10)),
                ...
                ('profile_unlocked', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='unlocked_by', to='api.profile')),
            ],
        ),
    ]
